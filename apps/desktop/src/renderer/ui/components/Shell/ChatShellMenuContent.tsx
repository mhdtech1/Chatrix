            ...
            <div className="menu-group">
              ...
              <label className="menu-check">
                <input
                  ...
                  onChange={(event) =>
                    onWelcomeModeChange(event.target.checked)
                  }
                />
              ...
              <div className="menu-group">
                ...
                <label className="menu-inline">
                  ...
                  <input
                    value={tabGroupDraft}
                    onChange={(event) =>
                      onTabGroupDraftChange(event.target.value)
                    }
              ...
              <div className="menu-group">
                ...
                <label className="menu-inline">
                  ...
                  <select
                    ...
                    onChange={(event) =>
                      onTabAlertProfileChange(
                        event.target.value as TabAlertProfile,
                      )
                    }
                  >
              ...
              <div className="menu-group">
                ...
                <div className="menu-health-list">
                  <div className="menu-health-card">
                    ...
                    <span>
                      User:{" "}
                      {authHealth?.twitch.username || twitchUsername || "n/a"}
                    </span>
                    <span>
                  ...
                  <div className="menu-health-card">
                    ...
                    <span>
                      Can send: {authHealth?.kick.canSend ? "yes" : "no"}
                    </span>
                    <span>
                    ...
                    <span>
                      Can mod (active tab):{" "}
                      {canModerateActiveTab &&
                      activeSingleSourcePlatform === "kick"
                        ? "yes"
                        : "no"}
                    </span>
                    <span>
